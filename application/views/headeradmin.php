    ...
    <div id="all">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="<?php echo base_url("assets/img/")?>logo3.png" class="d-none d-md-inline-block"><img src="<?php echo base_url("assets/img/")?>logo3.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
            <button type="button" data-toggle="collapse" data-target="#navigation" class="navbar-toggler btn-template-outlined"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
            
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                <li><a href="index.html"> <i class="caret"></i>Beranda</a></li>
                <li><a href="index.html"> <i class="caret"></i>Penyakit</a></li>
                <li><a href="index.html"> <i class="caret"></i>Gejala</a></li>
                <li><a href="index.html"> <i class="caret"></i>Relasi</a></li>
                <li><a href="index.html"> <i class="caret"></i>Riwayat Pasien</a></li>
                <li><a href="index.html"> <i class="caret"></i>Data Pasien</a></li>
              </ul>
            </div>
